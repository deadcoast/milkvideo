...
class TestEnhancedMenuSystem:
    ...
    def menu_system(self, mock_settings):
        ...
        with (
            patch("videomilker.cli.menu_system.Console"),
    ...
    def test_question_mark_shortcut(self, menu_system):
        ...
        # Mock both methods
        with (
            patch.object(menu_system, "_show_keyboard_shortcuts") as mock_show_shortcuts,
    ...
    def test_help_menu_structure(self, menu_system):
        ...
        if call_args and call_args[0]:
            ...
            if len(call_args[0]) > 1:
                ...
                expected_options = ["1", "2", "3", "4", "5", "6", "7", "8", "0"]
    ...
    def test_menu_renderer_enhancements(self):
        ...
        with (
            patch("videomilker.cli.menu_renderer.Console") as mock_console_class,
