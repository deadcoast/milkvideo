...
class ConfigManager:
    ...
    def _validate_download_settings(self, download_settings) -> List[str]:
        ...
        if download_settings.default_quality not in valid_qualities:
            errors.append(
                f"Invalid default quality '{download_settings.default_quality}'. Must be one of: {valid_qualities}"
            )
        ...
        if download_settings.default_format not in valid_formats:
            errors.append(
                f"Invalid default format '{download_settings.default_format}'. Must be one of: {valid_formats}"
            )
    ...
    def _validate_ui_settings(self, ui_settings) -> List[str]:
        ...
        if ui_settings.progress_bar_style not in valid_styles:
            errors.append(
                f"Invalid progress bar style '{ui_settings.progress_bar_style}'. Must be one of: {valid_styles}"
            )
    ...
    def _validate_history_settings(self, history_settings) -> List[str]:
        ...
        if history_settings.export_format not in valid_export_formats:
            errors.append(
                f"Invalid export format '{history_settings.export_format}'. Must be one of: {valid_export_formats}"
            )
    ...
    def _validate_advanced_settings(self, advanced_settings) -> List[str]:
        ...
        if advanced_settings.proxy and not advanced_settings.proxy.startswith(("http://", "https://", "socks5://")):
    ...
    def _validate_format_settings(self, format_settings) -> List[str]:
        ...
        errors = [
            f"Invalid video format '{fmt}'. Must be one of: {valid_video_formats}"
        ...
        errors.extend(
            f"Invalid audio format '{fmt}'. Must be one of: {valid_audio_formats}"
        ...
        if format_settings.preferred_video_codec not in valid_video_codecs:
            errors.append(
                f"Invalid preferred video codec '{format_settings.preferred_video_codec}'. Must be one of: {valid_video_codecs}"
            )
        ...
        if format_settings.preferred_audio_codec not in valid_audio_codecs:
            errors.append(
                f"Invalid preferred audio codec '{format_settings.preferred_audio_codec}'. Must be one of: {valid_audio_codecs}"
            )
        ...
        if format_settings.max_resolution not in valid_resolutions:
            errors.append(
                f"Invalid max resolution '{format_settings.max_resolution}'. Must be one of: {valid_resolutions}"
            )

        if format_settings.min_resolution not in valid_resolutions:
            errors.append(
                f"Invalid min resolution '{format_settings.min_resolution}'. Must be one of: {valid_resolutions}"
            )
    ...
    def _validate_post_processing_settings(self, post_processing_settings) -> List[str]:
        ...
        if post_processing_settings.audio_format not in valid_audio_formats:
            errors.append(
                f"Invalid audio format for extraction '{post_processing_settings.audio_format}'. Must be one of: {valid_audio_formats}"
            )
        ...
        if post_processing_settings.convert_subs not in valid_subtitle_formats:
            errors.append(
                f"Invalid subtitle conversion format '{post_processing_settings.convert_subs}'. Must be one of: {valid_subtitle_formats}"
            )
